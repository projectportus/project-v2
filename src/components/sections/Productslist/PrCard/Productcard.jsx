...
const ProductCard = ({title,desc,price, image, offer, badgeStatus, discount}) => {
  ...
  return (
    <div className='card-product w-fit bg mb-5 relative'>
      {badgeStatus && 
      <div className="bagde absolute top-4 right-4 md:top-[24px] md:right-[24px] text-[12px] md:text-[1rem] w-[30px]  h-[30px] md:w-[48px] md:h-[48px] rounded-4xl flex justify-center items-center text-white" style={{ backgroundColor: color }}>
        {offer}
      </div>}
