...
const Form = () => {
    const [formData, setFormData] = useState({
      ...
      const [successMessage, setSuccessMessage] = useState(""); // Уведомление об отправке
  ...
  <div className='w-full md:h-[1114px] flex items-end justify-center '>
    <div className='w-[90%] md:h-[90%] flex flex-col items-center  '>
        ...
        <div className=' h-fit flex flex-col items-center mt-[20px] md:mt-0'>
            <div className='text-[8vw] md:text-[36px] font-semibold w-fit'>Get In Touch With Us</div>
                    ...
                    <form  onSubmit={handleSubmit}
                         className='w-full h-[90%] gap-5 md:gap-0 flex flex-col justify-around'>
                            <div className="h-fit relative w-full flex flex-col justify-between ">
                                ...
                                className={`h-[75px] mt-[22px] w-full border-2 ${
                                  ...
                                  value={formData.name}
                                   ...
                                   />
                                    {errors.name && <p className=" text-sm absolute translate-y-[-60%] w-fit bg-white left-[10px] top-[48px]">{errors.name}</p>}
                            </div>
                            <div className="h-fit relative w-full flex flex-col justify-between ">
                                <label className='text-[16px]' htmlFor="">
                                    Email address
                                ...
                                />
                                  {errors.email && <p className=" absolute translate-y-[-60%] w-fit bg-white left-[10px] top-[48px] text-sm">{errors.email}</p>}
                            </div>
                            <div className="h-fit relative w-full flex flex-col justify-between ">
                                <label className='text-[16px]' htmlFor="">
                                    Subject
                            ...
                            <div className="h-fit relative w-full flex flex-col justify-between ">
                                ...
                                />
                                    {errors.message && <p className=" absolute translate-y-[-60%] w-fit bg-white left-[10px] top-[48px] text-sm">{errors.message}</p>}
                            </div>
                        ...
                        {successMessage && (
                            <div className="mt-3 p-2 bg-[#B88E2F] w-fit text-white rounded">{successMessage}</div>
                        )}
                </div>
            </div>
        </div>
