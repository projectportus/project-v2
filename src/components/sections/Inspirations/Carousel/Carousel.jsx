  ...
  return (
    <div className='w-[100%] max-[768px]:mt-5 md:w-[55%] h-[80%] mb-5'>
      <div className="carbody md:w-[100%] h-[486px] m-left relative flex justify-between max-[768px]:flex-col items-center ">
          <div style={{backgroundImage: `url(${dataImages[next]})`}} className="w-[80%] h-[100%] car-cards md:w-[372px] md:h-[486px] rounded-2xl bg-center bg-cover duration-500 transform origin-bottom-right hover:w-[404px] hover:h-[585px] relative group flex justify-center items-end ">
          ...
          <div style={{backgroundImage: `url(${dataImages[(next+1) % totalSlides]})`}} className="car-cards w-[372px] h-[486px] rounded-2xl transition-opacity duration-700 bg-center bg-cover max-[1024px]:hidden "></div>
          <div className="arrow-next absolute right-[0%] top-50" onClick={nextCard}>
