        ...
        <div className="mask text-center w-[80vw]  md:mr-15 md:w-160 md:h-110 md:text-start flex md:justify-center items-center rounded-2xl">
            <div className="wrapper flex flex-col justify-between">
                <div className="text-content md:w-xl md:h-90 flex flex-col items-center md:items-start md:justify-between p-5 ">
                    <h6 className='text-[1.5rem] w-fit md:text-lg tracking-widest font-bold '>New Arrival</h6>
                    <h1 className='text-[1.5rem]  w-fit md:text-5xl md:mt-0 mt-2 text-[#B88E2F] md:flex md:justify-start justify-center flex-wrap'>Discover Our <span>New Collection</span> </h1>
                    <p className='text-[0.85rem]  w-fit md:text-xl md:mt-0 mt-2'>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Ut  elit tellus, luctus nec ullamcorper mattis.</p>
