...
export default function ProductsFilter({ search, setSearch, perPage, setPerPage, startIndex, endIndex, totalResults }) {
    ...
    <div className="filt w-full bg-[#F9F1E7] flex flex-col gap-[20px] items-center md:flex-row md:justify-around md:gap-[25%] p-2 md:p-4 ">
      ...
      <div className="flex flex-wrap md:flex-nowrap items-center gap-2 md:gap-4 ">
        ...
        <div className="flex items-center md:w-[288px] gap-2">
          <span className="sort text-[16px] md:text-[20px] font-normal">Sort By</span>
          <Input
            placeholder="Default"
            className="w-[140px] h-[55px] md:w-[188px] bg-white p-3 md:p-6 border-gray-300"
            value={search}
